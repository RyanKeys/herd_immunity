...
class Simulation:
    ...
    def print_population(self):
        ...
        for person in self.population:
            print(person, person.is_vaccinated)
    ...
    def simulation_should_continue(self):
        ...
        if infected == 0 and self.total_dead == self.population_size:
            return False
    ...
    def time_step(self, infected):
        ...
        for infected_person in infected:
            ...
            for i in range(10):
                random_num = random.randrange(0, self.population_size)
